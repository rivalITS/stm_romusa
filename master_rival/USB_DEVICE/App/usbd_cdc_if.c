...
extern short int tarArm, tarLifter, limArm, limLifter;


extern bool vacuum_status;
extern bool pneumatic_stat;
extern bool startButton, retryButton;
extern bool pump_stat, servo_stat;

extern uint32_t var;

uint8_t recv_dummy[43];
